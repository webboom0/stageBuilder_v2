...
class Timeline {
  ...
  play() {
    ...
    if (this.editor.scene?.userData?.audioTimeline?.audioObjects) {
      ...
      Object.values(audioObjects).forEach((audioObject) => {
        if (audioObject.audioElement) {
          const audio = audioObject.audioElement;
          const sprite = audioObject.element?.querySelector(".audio-sprite");
