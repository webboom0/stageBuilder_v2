...
export class MotionTimeline extends BaseTimeline {
  ...
  `;
    ...
    updatePlayheadPosition(percent) {
        ...
        const timelineViewportPlayhead = document.querySelector(".timeline-viewport .playhead");
        ...
        console.log("MotionTimeline playhead 요소들 찾기:", {
            ...
            timelineViewportPlayhead: !!timelineViewportPlayhead,
        ...
        if (timelineViewportPlayhead) {
            timelineViewportPlayhead.style.left = `${percent}%`;
            console.log("timeline-viewport playhead 업데이트 완료");
        }
